<?php
/**
 * Makes sure there is one space around the concatenation operator.
 * This edited file allows for concatonators to start with just spaces
 * before them
 * $x = 'this'
 *          . 'and that'
 *          . 'and that';
 *
 * @authro    Tom H Anderson <tom.h.anderson@gmail.com>
 * @author    Greg Sherwood <gsherwood@squiz.net>
 * @copyright 2006-2015 Squiz Pty Ltd (ABN 77 084 670 600)
 * @license   https://github.com/squizlabs/PHP_CodeSniffer/blob/master/licence.txt BSD Licence
 */

namespace ApiSkeletons\Sniffs\Strings;
...
class ConcatenationSpacingSniff implements Sniff
{
    ...
    /**
     * Allow more than one space if concatonation starts a new line
     *
     * @var boolean
     */
    public $ignoreBefore = true;
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if ($fix === true) {
            ...
            if ($this->ignoreBefore === false && ($before !== 'newline' || $this->ignoreNewlines === false)) {
                if ($tokens[($stackPtr - 1)]['code'] === T_WHITESPACE) {
